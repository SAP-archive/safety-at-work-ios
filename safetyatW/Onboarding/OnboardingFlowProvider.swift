...
public class OnboardingFlowProvider: OnboardingFlowProviding {
    ...
    private func configuredWelcomeScreenStep() -> WelcomeScreenStep {
        ...
        let discoveryConfigurationTransformer = DiscoveryServiceConfigurationTransformer(applicationID: appParameters["Application Identifier"] as? String, authenticationPath: destination+"?$format=json")
        ...
        welcomeScreenStep.welcomeScreenCustomizationHandler = { welcomeStepUI in
            welcomeStepUI.headlineLabel.text = "Safety@work"
            welcomeStepUI.detailLabel.text = NSLocalizedString("keyWelcomeScreenMessage", value: "This application was generated by SAP Cloud Platform SDK for iOS to help enterprise in crowd monitoring, contact tracing and manage contact distance", comment: "XMSG: Message on WelcomeScreen")
