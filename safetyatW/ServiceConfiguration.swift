...
class ServiceConfiguration {
    ...
    public static func getHRphone() -> String {
           let id = serviceConfiguration.root.value(forKey: "HRphoneNumber") as! String
           return id
       }
    public static func getBeaconUUID() -> String {
              let id = serviceConfiguration.root.value(forKey: "BeaconUUID") as! String
              return id
          }
}
